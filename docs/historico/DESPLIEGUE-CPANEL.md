> **Histórico.** Este documento describe el despliegue en cPanel con Passenger,
> que ya no se usa. El despliegue vigente está en
> [`DESPLIEGUE-VPS.md`](../DESPLIEGUE-VPS.md). Se conserva como referencia.
